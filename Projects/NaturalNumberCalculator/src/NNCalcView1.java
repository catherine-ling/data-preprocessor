...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        JPanel bPanelMain = new JPanel(new GridLayout(
        ...
        bPanelMain.add(this.bDigits[7]);
        bPanelMain.add(this.bDigits[8]);
        bPanelMain.add(this.bDigits[9]);
        bPanelMain.add(this.bAdd);

        bPanelMain.add(this.bDigits[4]);
        bPanelMain.add(this.bDigits[5]);
        bPanelMain.add(this.bDigits[6]);
        bPanelMain.add(this.bSubtract);

        bPanelMain.add(this.bDigits[1]);
        bPanelMain.add(this.bDigits[2]);
        bPanelMain.add(this.bDigits[3]);
        bPanelMain.add(this.bMultiply);

        bPanelMain.add(this.bDigits[0]);
        bPanelMain.add(this.bPower);
        bPanelMain.add(this.bRoot);
        bPanelMain.add(this.bDivide);

        /*
         * Create side button panel
         */

        JPanel bPanelSide = new JPanel(new GridLayout(
        ...
        bPanelSide.add(this.bClear);
        bPanelSide.add(this.bSwap);
        bPanelSide.add(this.bEnter);
        ...
        JPanel bPanelCombo = new JPanel(new FlowLayout());

        /*
         * Add the other two button panels to the combined button panel
         */

        bPanelCombo.add(bPanelMain);
        bPanelCombo.add(bPanelSide);
